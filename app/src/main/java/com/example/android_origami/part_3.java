...
public class part_3 {
    ...
    private float[] vertices = {  // Vertices of the triangle
            0f * MainActivity.scale_factor, 0.0f * MainActivity.scale_factor, 0.0f,
            85f * MainActivity.scale_factor, 0.0f * MainActivity.scale_factor, 0.0f,
            85f * MainActivity.scale_factor, 85.0f * MainActivity.scale_factor, 0.0f
    };

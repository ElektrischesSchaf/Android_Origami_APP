...
public class part_13_2 {
    ...
    private float[] vertices = {  // Vertices of the triangle
            0f * MainActivity.scale_factor, -85f * MainActivity.scale_factor, 0.0f,
            -25f * MainActivity.scale_factor, (-85f+25f) * MainActivity.scale_factor, 0.0f,
            -25f * MainActivity.scale_factor, -85f * MainActivity.scale_factor, 0.0f
    };
    ...
    public void draw(GL10 gl) {
        ...
        Log.d("In part_13_2: ","draw(GL10 gl)");
    }
}
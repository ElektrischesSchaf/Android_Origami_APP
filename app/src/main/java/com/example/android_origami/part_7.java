...
public class part_7 {
    ...
    private float[] vertices = {  // Vertices of the triangle
            ...
            0f * MainActivity.scale_factor, 105f * MainActivity.scale_factor, 0.0f,
            -20f * MainActivity.scale_factor, 130f * MainActivity.scale_factor, 0.0f,
            -130f * MainActivity.scale_factor, 20f * MainActivity.scale_factor, 0.0f,
            -105f * MainActivity.scale_factor, 0f * MainActivity.scale_factor, 0.0f
    };
    private byte[] indices = { 0, 1, 2 ,0, 2, 3,0, 3, 4}; // Indices to above vertices (in CCW)
